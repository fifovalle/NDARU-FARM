...
const ModalHapusJasa = ({ terbuka, tanganiTutup, hapusJasa }) => {
  return (
    <Dialog
      open={terbuka}
    ...
    >
      <DialogHeader className="text-white flex items-center gap-2">
        <ShieldExclamationIcon className="w-6 h-6 text-red-500" /> Hapus Jasa
      </DialogHeader>
      <DialogBody
        divider
      ...
      >
        <p className="text-center">
          Apakah kamu yakin ingin menghapus jasa ini? Tindakan ini tidak dapat
          diurungkan.
        </p>
      </DialogBody>
