...
const ModalHapusSaranaPertanian = ({
  terbuka,
  tanganiTutup,
  ...
  return (
    ...
    >
      <DialogHeader className="text-white flex items-center gap-2">
        <ShieldExclamationIcon className="w-6 h-6 text-red-500" /> Hapus Sarana
        Pertanian
      </DialogHeader>
      <DialogBody
        divider
      ...
      >
        <p className="text-center">
          Apakah kamu yakin ingin menghapus sarana pertanian ini? Tindakan ini
...
export default ModalHapusSaranaPertanian;
