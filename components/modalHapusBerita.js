...
const ModalHapusBerita = ({ terbuka, tanganiTutup, hapusBerita }) => {
  return (
    <Dialog
      open={terbuka}
    ...
    >
      <DialogHeader className="text-white flex items-center gap-2">
        <ShieldExclamationIcon className="w-6 h-6 text-red-500" /> Hapus Berita
      </DialogHeader>
      <DialogBody
        divider
      ...
      >
        <p className="text-center">
          Apakah kamu yakin ingin menghapus berita ini? Tindakan ini tidak dapat
          diurungkan.
        </p>
      </DialogBody>
...
export default ModalHapusBerita;
